          ...
          children: [
            Padding(
              ...
              child: Container(
                ...
                child: PageView.builder(
                  ...
                  onPageChanged: (index){
                    setState((){
                      currentIndex=index%controller.modal.value.featuredCars!.length;
                    });
                  },
                        ...
                        Stack(
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: Image.network(item![index%controller.modal.value.featuredCars!.length].thumbnail.toString(),fit: BoxFit.cover,),
                            ),
                            ...
                            child: Column(
                              ...
                              children: [
                                Align(
                                    ...
                                    child: Text(item[index%controller.modal.value.featuredCars!.length].title.toString(),style: TextStyle(fontWeight: FontWeight.w700),)),

                                Text(item[index%controller.modal.value.featuredCars!.length].location.toString(),style: TextStyle(),),
                                SizedBox(height: 8,),

                                Container(
                                  width:Get.size.width*0.26,
                                  decoration:BoxDecoration(borderRadius:BorderRadius.circular(5),color:TColor.mainRedColor),
                                  child: Padding(
                                    padding: const EdgeInsets.symmetric(vertical: 5.5,horizontal: 7.4),
                                    child: RatingBarIndicator(
                                      // rating: 3.3,
                                      rating: double.parse(item[index%controller.modal.value.featuredCars!.length].avgReviews!.totalReviews.toString()),
                                      itemBuilder: (context, index) =>
                                ...
                                RichText(text: TextSpan(
                                    children: [
                                      ...
                                      TextSpan(text: '  '),
                                      TextSpan(text: item[index%controller.modal.value.featuredCars!.length].price.toString(),style: TextStyle(fontSize: 17,fontWeight: FontWeight.bold,color: Colors.black)),
                                    ]
                                )),
                                Row(
                                  children: [
                                    Text('featurehotelDetailText'.tr,style: TextStyle(fontSize: 12),),
                                    SizedBox(width: 6,),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  for(var i =0;i<controller.modal.value.featuredCars!.length ;i++)
