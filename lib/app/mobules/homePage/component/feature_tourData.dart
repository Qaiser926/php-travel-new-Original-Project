          ...
          children: [
            Padding(
              ...
              child: Container(
                ...
                child: PageView.builder(
                  ...
                  onPageChanged: (index){
                    setState((){
                      currentIndex=index%controller.modal.value.featuredTours!.length;
                    });
                  },
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: Container(
                            ...
                            child: Image.network(item![index%controller.modal.value.featuredTours!.length].thumbnail.toString(),fit: BoxFit.cover,),
                          ),
                        ),
                        Column(
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Center(child: Text(controller.modal.value.featuredTours![index%controller.modal.value.featuredTours!.length].location.toString(),style: TextStyle(color: Colors.white),)),
                                ),
                              ),
                            ),
                          Padding(
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: RatingBarIndicator(
                                        // rating: 3.3,
                                        rating: double.parse(item[index%controller.modal.value.featuredTours!.length].avgReviews!.totalReviews.toString()),
                                        itemBuilder: (context, index) =>
                                    ...
                                    Text(controller.modal.value.featuredTours![index%controller.modal.value.featuredTours!.length].avgReviews!.overall.toString(),style: TextStyle(color: Colors.white),),
                                    Text(' )',style: TextStyle(color: Colors.white)),
                                  ],
                                ),
                                Align(
                                  alignment: Alignment.bottomLeft,
                                  child: Text(controller.modal.value.featuredTours![index%controller.modal.value.featuredTours!.length].title.toString(),style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 17.5)),
                                ),
                                Row(
                                  children: [
                                    Padding(
                                      padding: const EdgeInsets.only(left: 2),
                                      child: Text('Price',style:TextStyle(color: Colors.white,fontSize: 12)),
                                    ),
                                    Padding(
                                      padding: const EdgeInsets.only(left: 4),
                                      child: Align(
                                        alignment: Alignment.bottomLeft,
                                        child: Text("USD",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 17.5)),
                                      ),
                                    ),
                                    Padding(
                                      padding: const EdgeInsets.only(left: 4),
                                      child: Align(
                                        alignment: Alignment.bottomLeft,
                                        child: Text(controller.modal.value.featuredTours![index%controller.modal.value.featuredTours!.length].price.toString(),style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 17.5)),
                                      ),
                                    ),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  for(var i =0;i<controller.modal.value.featuredTours!.length ;i++)
