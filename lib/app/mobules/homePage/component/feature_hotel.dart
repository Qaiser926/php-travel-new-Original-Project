          ...
          children: [
                        ...
                        Stack(
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: Image.network(item![index%controller.modal.value.featuredHotels!.length].thumbnail.toString(),fit: BoxFit.cover,),
                            ),
                            ...
                            child: Column(
                              ...
                              children: [
                                Align(
                                    ...
                                    child: Text(item[index%controller.modal.value.featuredHotels!.length].title.toString(),style: TextStyle(fontWeight: FontWeight.w700),)),

                                Text(item[index%controller.modal.value.featuredHotels!.length].location.toString(),style: TextStyle(),),
                                SizedBox(height: 8,),

                                RatingBarIndicator(
                                  // rating: 3.3,
                                  rating: double.parse(item[index%controller.modal.value.featuredHotels!.length].avgReviews!.totalReviews.toString()),
                                  itemBuilder: (context, index) =>
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  for(var i =0;i<controller.modal.value.featuredHotels!.length ;i++)
