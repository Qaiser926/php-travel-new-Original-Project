...
class _FeatureFlightState extends State<FeatureFlight> {
  ...
  Widget build(BuildContext context) {
    ...
    return  Row(
      ...
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
      Text(item![index%controller.modal.value.featuredFlights!.length].title.toString(),style: TextStyle(fontWeight: FontWeight.w700,fontSize: 15),),
        SizedBox(height: 10,),
      ...
      Container(
        ...
        child: Row(
        children: [
        Expanded(child: Text(item![index%controller.modal.value.featuredFlights!.length].title.toString(),style: TextStyle(fontWeight: FontWeight.w500,color: Colors.black87),)),
        SizedBox(width: 8,),
        Icon(Icons.arrow_forward,size: 19,color: Colors.grey.shade600,),
        SizedBox(width: 8,),
        Expanded(child: Text(item![index%controller.modal.value.featuredFlights!.length].title.toString(),style: TextStyle(fontWeight: FontWeight.w500,color: Colors.black87),)),
        ],
        ),
      ...
      children: [
      TextSpan(text: 'From'.tr,style: TextStyle(color: Colors.black,fontSize: 15)),
      TextSpan(text: '    '),
      TextSpan(text: 'USD',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black,fontSize: 16.5)),
      TextSpan(text: '  '),
      TextSpan(text: item![index%controller.modal.value.featuredFlights!.length].price.toString(),style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16.5,color: Colors.black)),
      ]
      ))
